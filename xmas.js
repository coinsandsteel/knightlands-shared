...
export const perksUnlockBranchBase = {
    [TOWER_PERK_AUTOCYCLES_COUNT]: [TOWER_PERK_UPGRADE],
    [TOWER_PERK_UPGRADE]: [TOWER_PERK_CYCLE_DURATION, TOWER_PERK_INCOME],
...
export const perksUnlockBranchV1 = {
    [TOWER_PERK_AUTOCYCLES_COUNT]: [TOWER_PERK_UPGRADE],
    [TOWER_PERK_UPGRADE]: [TOWER_PERK_CYCLE_DURATION],
    [TOWER_PERK_CYCLE_DURATION]: [TOWER_PERK_INCOME],
}

export const perksUnlockBranchV2 = {
    [TOWER_PERK_AUTOCYCLES_COUNT]: [TOWER_PERK_UPGRADE],
    [TOWER_PERK_UPGRADE]: [TOWER_PERK_CYCLE_DURATION],
    [TOWER_PERK_CYCLE_DURATION]: [TOWER_PERK_SPEED],
    [TOWER_PERK_SPEED]: [TOWER_PERK_SUPER_SPEED]
}

export const perksUnlockBranchV3 = {
    [TOWER_PERK_AUTOCYCLES_COUNT]: [TOWER_PERK_UPGRADE],
    [TOWER_PERK_UPGRADE]: [TOWER_PERK_INCOME],
    [TOWER_PERK_INCOME]: [TOWER_PERK_BOOST],
    [TOWER_PERK_BOOST]: [TOWER_PERK_SUPER_BOOST]
}

export const perksUnlockMap = {
    [CURRENCY_SANTABUCKS]: {
        all: _.cloneDeep(perksUnlockBranchBase)
    },
    [CURRENCY_GOLD]: {
        all: _.cloneDeep(perksUnlockBranchBase)
    },
    ...
    [CURRENCY_SHINIES]: {
        all: perksUnlockBranchV1
    },
    [CURRENCY_CHRISTMAS_POINTS]: {
        '4': _.cloneDeep(perksUnlockBranchV2),
        '7': _.cloneDeep(perksUnlockBranchV3),
        '8': _.cloneDeep(perksUnlockBranchV2),
        '9': _.cloneDeep(perksUnlockBranchV3),
    }
}
...
export const getUpgradeTotalPriceAtLevel = function({ upgradeMultiplier, baseSaleBuilding, perksMultiplier }, level) {
    return (Math.pow(upgradeMultiplier, level) - 1) / (upgradeMultiplier - 1) * baseSaleBuilding / perksMultiplier;
}
