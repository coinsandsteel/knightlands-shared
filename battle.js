...
export const ABILITY_INITIATIVE = "heal_initiative";
...
export const ABILITY_TYPES = {
  ...
  [ABILITY_RUSH]: ABILITY_GROUP_JUMP,
  [ABILITY_TELEPORTATION]: ABILITY_GROUP_JUMP,
  
  [ABILITY_MIGHT]: ABILITY_GROUP_BUFF,
  [ABILITY_SHIELD]: ABILITY_GROUP_BUFF,
  [ABILITY_WIND_WALK]: ABILITY_GROUP_BUFF,
  
  [ABILITY_CURSE]: ABILITY_GROUP_DE_BUFF,
  [ABILITY_FROZEN_ABYSS]: ABILITY_GROUP_DE_BUFF,
  [ABILITY_HAMSTRING]: ABILITY_GROUP_DE_BUFF,
  [ABILITY_LAZINESS]: ABILITY_GROUP_DE_BUFF,
  [ABILITY_SHIELD_STUN]: ABILITY_GROUP_DE_BUFF,
  [ABILITY_STUN]: ABILITY_GROUP_DE_BUFF,
  [ABILITY_STUN_SHOT]: ABILITY_GROUP_DE_BUFF,
  [ABILITY_WEAKNESS]: ABILITY_GROUP_DE_BUFF,
  
  [ABILITY_HEAVY_ARROW]: ABILITY_GROUP_SELF_BUFF,
  [ABILITY_RAGE]: ABILITY_GROUP_SELF_BUFF,
  [ABILITY_SHIELD_WALL]: ABILITY_GROUP_SELF_BUFF,
  [ABILITY_ZEALOT]: ABILITY_GROUP_SELF_BUFF,
  
  [ABILITY_ACCURATE_SHOT]: ABILITY_GROUP_ATTACK,
  [ABILITY_AGRESSION]: ABILITY_GROUP_ATTACK,
  [ABILITY_ARROW_CRUSH]: ABILITY_GROUP_ATTACK,
  [ABILITY_AXE_BLOW]: ABILITY_GROUP_ATTACK,
  [ABILITY_AXE_CRUSH]: ABILITY_GROUP_ATTACK,
  [ABILITY_BLADE_VORTEX]: ABILITY_GROUP_ATTACK,
  [ABILITY_CRUSH_OF_DOOM]: ABILITY_GROUP_ATTACK,
  [ABILITY_DARK_VORTEX]: ABILITY_GROUP_ATTACK,
  [ABILITY_DEATH_SHOT]: ABILITY_GROUP_ATTACK,
  [ABILITY_DOUBLE_SHOT]: ABILITY_GROUP_ATTACK,
  [ABILITY_DRAGON_BITE]: ABILITY_GROUP_ATTACK,
  [ABILITY_DRAGON_FURY]: ABILITY_GROUP_ATTACK,
  [ABILITY_ENERGY_BOLT]: ABILITY_GROUP_ATTACK,
  [ABILITY_FATAL_STRIKE]: ABILITY_GROUP_ATTACK,
  [ABILITY_FIRE_BLADE]: ABILITY_GROUP_ATTACK,
  [ABILITY_FLAME_STRIKE]: ABILITY_GROUP_ATTACK,
  [ABILITY_FROST_BLADE]: ABILITY_GROUP_ATTACK,
  [ABILITY_FURY_CLAWS]: ABILITY_GROUP_ATTACK,
  [ABILITY_HEAVY_STRIKE]: ABILITY_GROUP_ATTACK,
  [ABILITY_HOLY_STRIKE]: ABILITY_GROUP_ATTACK,
  [ABILITY_HUMMER_BLOW]: ABILITY_GROUP_ATTACK,
  [ABILITY_HURRICANE]: ABILITY_GROUP_ATTACK,
  [ABILITY_JAVELIN_THROW]: ABILITY_GROUP_ATTACK,
  [ABILITY_KUNAI_STRIKE]: ABILITY_GROUP_ATTACK,
  [ABILITY_LETHAL_SHOT]: ABILITY_GROUP_ATTACK,
  [ABILITY_LETHAL_STRIKE]: ABILITY_GROUP_ATTACK,
  [ABILITY_MORTAL_BLOW]: ABILITY_GROUP_ATTACK,
  [ABILITY_POWER_SHOT]: ABILITY_GROUP_ATTACK,
  [ABILITY_POWER_STRIKE]: ABILITY_GROUP_ATTACK,
  [ABILITY_RETRIBUTION]: ABILITY_GROUP_ATTACK,
  [ABILITY_SHIELD_STRIKE]: ABILITY_GROUP_ATTACK,
  [ABILITY_SPEAR_STRIKE]: ABILITY_GROUP_ATTACK,
  [ABILITY_STRONG_PUNCH]: ABILITY_GROUP_ATTACK,
  [ABILITY_SWORD_CRUSH]: ABILITY_GROUP_ATTACK,
  [ABILITY_WOLF_BITE]: ABILITY_GROUP_ATTACK,
};
...
const TERRAIN_GRASS = 'grass';
const TERRAIN_GRASS_HILL = 'grass_hill';
const TERRAIN_GRASS_SWAMP = 'grass_swamp';
const TERRAIN_GRASS_SWAMP_A = 'grass_swamp_a';
const TERRAIN_GRASS_SWAMP_B = 'grass_swamp_b';
const TERRAIN_GRASS_SWAMP_C = 'grass_swamp_c';
const TERRAIN_GRASS_SWAMP_D = 'grass_swamp_d';
const TERRAIN_GRASS_SWAMP_X = 'grass_swamp_x';
const TERRAIN_GRASS_SWAMP_Y = 'grass_swamp_y';
const TERRAIN_GRASS_SWAMP_Z = 'grass_swamp_z';
const TERRAIN_GRASS_SWAMP1 = 'grass_swamp1';
const TERRAIN_GRASS_SWAMP2 = 'grass_swamp2';
const TERRAIN_GRASS_WOODS = 'grass_woods';
const TERRAIN_SAND = 'sand';
const TERRAIN_SAND_HILL = 'sand_hill';
const TERRAIN_SAND_LAVA = 'sand_lava';
const TERRAIN_SAND_LAVA_A = 'sand_lava_a';
const TERRAIN_SAND_LAVA_B = 'sand_lava_b';
const TERRAIN_SAND_LAVA_C = 'sand_lava_c';
const TERRAIN_SAND_LAVA_D = 'sand_lava_d';
const TERRAIN_SAND_LAVA1 = 'sand_lava1';
const TERRAIN_SAND_LAVA2 = 'sand_lava2';
const TERRAIN_SAND_QUICKSAND = 'sand_quicksand';
const TERRAIN_SAND_THORNS = 'sand_thorns';
const TERRAIN_SNOW = 'snow';
const TERRAIN_SNOW_HILL = 'snow_hill';
const TERRAIN_SNOW_ICE = 'snow_ice';
const TERRAIN_SNOW_ICE_1 = 'snow_ice_1';
const TERRAIN_SNOW_ICE_1_1 = 'snow_ice_1-1';
const TERRAIN_SNOW_ICE_A = 'snow_ice_a';
const TERRAIN_SNOW_ICE_B = 'snow_ice_b';
const TERRAIN_SNOW_ICE_C = 'snow_ice_c';
const TERRAIN_SNOW_ICE_D = 'snow_ice_d';
const TERRAIN_SNOW_WOODS = 'snow_woods';
